...
while True:
	...
	if (("run" in p.lower())  or  ("open" in p.lower())  or  ("launch" in p.lower()))  and (("chrome" in p.lower()) or ("google" in p.lower())):
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching google chrome for ya")
	    os.system("chrome")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching windows camera for ya")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching calculator for ya")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching notepad for ya  ")
	    os.system("notepad")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching skylab for ya")
	    os.system("scilab")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching spotify for ya")
	    os.system("spotify")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching microsoft word for ya")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching windows store for ya ")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching command prompt for ya ")
	    os.system("cmd")

	elif (("run" in p.lower()) or ("open" in p.lower()) or ("launch" in p.lower())) and (("file" in p.lower()) and ("explorer" in p.lower())):
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    pyttsx3.speak("ok, i will not")
	    print("ok i will not")
	  else:
	    pyttsx3.speak("launching file explorer for ya ")
	    os.system("explorer")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching control panel for ya")
	    os.system("control")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching microsoft mail for ya ")
	    os.system("explorer.exe shell:appsFolder\microsoft.windowscommunicationsapps_8wekyb3d8bbwe!microsoft.windowslive.mai")

	elif (("run" in p.lower()) or ("open" in p.lower()) or ("launch" in p.lower())) and ("notepad++" in p.lower()):
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    pyttsx3.speak("ok, i will not")
	    print("ok i will not")
	  else:
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching google mail for ya ")
	    os.system("start www.gmail.com")

	elif (("run" in p.lower()) or ("open" in p.lower()) or ("launch" in p.lower())) and ("filpkart" in p.lower()):
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    pyttsx3.speak("ok, i will not")
	    print("ok i will not")
	  else:
	    pyttsx3.speak("launching flipkart sohpping website for ya")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching amazon shopping website for ya")
...
#	    os.system("start www.facebook.com/IIECRise")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching telegram for ya")
	    os.system("telegram")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    if (("y" in boo.lower()) or ("yes" in boo.lower())):
	        ...
	        pyttsx3.speak("GOOD CHOICE :) CHECK BEFORE EMPTYING BIN, WILL YA !!")
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    if (("iiec" in p.lower()) or ("iiec-rise" in p.lower())):
	      pyttsx3.speak("launching iiec rise youtube channel for ya ")
	      os.system("start https://www.youtube.com/channel/UCtY-JhEZ3iPLtozWGgd2efQ")
	    else:
	      pyttsx3.speak("launching youtube for ya")
	      os.system("start www.youtube.com")

	elif (("exit" in p.lower())  or ("quit" in p.lower()) or ("leave" in p.lower())):
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    pyttsx3.speak("ok, i will not")
	    print("ok i will not")
	  else:
	    pyttsx3.speak("Hope you enjoyed your time with me ")
	    break
	  ...
	  if (("don't" in p.lower()) or ("dont" in p.lower()) or ("do not" in p.lower())):
	    ...
	    pyttsx3.speak("launching task manager for ya")
	    os.system("taskmgr")
